...
local s2 = m:section( TypedSection, "Phase", translate(""), translate("The phase must match with another incoming connection to establish IPSec"))
...
ike_keylife = s2:taboption("phase1", Value, "ikelifetime", translate("Lifetime"), translate("The time duration for phase 1"))
...
ike_time = s2:taboption("phase1", ListValue, "ikeletter", translate("in"), translate(""))
...
keylife = s2:taboption("phase2", Value, "keylife", translate("Lifetime"), translate("The time duration for phase 2"))
...
time = s2:taboption("phase2", ListValue, "letter", translate("in"), translate(""))
